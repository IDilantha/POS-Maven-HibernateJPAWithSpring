...
public class MainFormController implements Initializable {
    ...
    private String getUsername(){
        return DEPCrypt.decode(env.getRequiredProperty("javax.persistence.jdbc.user"),"123");
    }

    private String getPassword(){
        return DEPCrypt.decode(env.getRequiredProperty("javax.persistence.jdbc.password"),"123");
    }
